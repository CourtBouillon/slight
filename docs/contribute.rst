...
You want to add some code to Slight, launch its tests or improve its
documentation? Thank you very much! Here are some tips to help you play with
Slight in good conditions.

The first step is to clone the repository, create a virtual environment and
install Slight dependencies.

.. code-block:: shell

   git clone https://github.com/CourtBouillon/slight.git
   cd slight
   python -m venv venv
...
If you’ve found a bug in Slight, it’s time to report it, and to fix it if you
can!
...
.. _GitHub: https://github.com/CourtBouillon/slight
...
The documentation home page is ``docs/_build/index.html``. You can open this
file in a browser to see the final rendering.
